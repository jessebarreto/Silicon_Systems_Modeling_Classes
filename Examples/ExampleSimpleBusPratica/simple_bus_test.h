...
#include "simple_bus_custom_mem.h"
...
SC_MODULE(simple_bus_test)
{
  ...
  simple_bus_custom_mem          *mem_custom;
    ...
    : C1("C1")
  {
    ...
    master_nb = new simple_bus_master_non_blocking("master_nb", 3, 0x100, false, 20);
    master_d = new simple_bus_master_direct("master_d", 0x100, 100);
    mem_fast = new simple_bus_fast_mem("mem_fast", 0x00, 0x7f);
    mem_slow = new simple_bus_slow_mem("mem_slow", 0x80, 0xff, 1);
    mem_custom = new simple_bus_custom_mem("mem_custom", 0x100, 0x1ff);
