...
enum CONSTANTS {
	INT_MEM_SIZE = 0x00500000,
	END_PROGRAM=   0x00400100,
};
...
enum ENDERECOS {
	M0_min = 0x00000000,	M1_min = 0x10010000,
	M0_max = 0x1000FFFF,	M1_max = 0x7FFFFFFF,
	
	DMA_min = 0xFFFF0020,	R_A_min = 0xFFFF0000,
	DMA_max = 0xFFFF002F,	R_A_max = 0xFFFF000F,
