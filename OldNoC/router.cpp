...
void Router::lerNorte() {
    for (;;) {
//        eh_norte = false; - It`s not necessary anymore
        dado_norte = i_norte->read();
		if(debug==3)
			cout <<"["<< this->name() << "]"<< "Leu Norte " << endl;
//        eh_norte = true;
...
void Router::Norte() {
    ...
    for (;;) {
		...
		if(debug==3)
			cout <<"["<< this->name() << "]"<< "Norte terminou " << endl;
    }//Fim do for
}//Fim da thread
...
void Router::Sul() {
    ...
    for (;;) {
		...
		if(debug==3)
			cout <<"["<< this->name() << "]"<< "Sul terminou " << endl;
    }//Fim do for
}//Fim da thread
...
void Router::Leste() {
    ...
    for (;;) {
		...
		if(debug==3)
			cout <<"["<< this->name() << "]"<< "Leste terminou " << endl;
    }//Fim do for
}//Fim da thread
...
// Funçao que executa o roteamento
/*
 * D? para melhorar a l?gica de roteamento.
 * Atualmente, o roteamento eh individualizado e soh funciona para essa NoC
 * Eh possivel deixar o codigo mais generalizado e que funcione para routers que possuam mais de 3 vizinhos
 *
*/
