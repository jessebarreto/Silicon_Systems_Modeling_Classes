...
int sc_main ( int argc, char *argv[]) {
	...
	mem.sw(0+M1_min,0x08100000);// Escrever instru��o JUMP para o endere�o 0x08100000 no endere�o 0 (o termo "+ M1_min" vai ser subtra�do na fun��o hash posteriormente).
